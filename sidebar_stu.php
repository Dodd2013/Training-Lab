<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
      <ul class="am-list admin-sidebar-list">
        ...
        <li><a href="admin-table.html"><span class="am-icon-table"></span> Feedback</a></li>
        ...
        <li><a href="admin-form.html"><span class="am-icon-user"></span> Personal information</a></li>
        <li><a href="admin-form.html"><span class="am-icon-pencil-square-o"></span> Announcement list</a></li>
